...
function Message({ author, time, children }) {
  return (
    <MessageContainer>
      <MessageHead>
        <MessageAuther>{author}</MessageAuther>
...
function App() {
  ...
  //做一些事=>eventlistener,useEffect
  //component render完拿資料＝>useEffect
  ...
  return (
    <Page>
      ...
      {messageApiError && (
        //render object會有什麼問題？ 防呆機制
        <ErrorMessage>
          Sometheing went wrong.{messageApiError.toString()}
        </ErrorMessage>
      )}
